...
const useStyles = makeStyles((theme) => ({
  container: {
    backgroundImage: "url(/assets/images/home/masaje-deportivo-home.png)",
    height: "90vh",
    width: "100%",
      ...
      <Grid item xs={12} sm={12} md={12} lg={12} xl={12}>
        <div className="container mx-auto xl:px-36 lg:px-36 px-0 ">
          <div className="w-1/2">
            ...
            >
              Masaje
              <span style={{ color: "#3F34BB" }}> deportivo</span>
            </Typography>
            <Typography
              variant="h6"
            ...
            >
              ...
              PRE o POST entrenamiento. También se enfoca en fortalecimiento.
            </Typography>
            <div className="mt-10">
              <CustomLinkButton
                className="primary"
