...
const useStyles = makeStyles((theme) => ({
  container: {
    backgroundImage: "url(/assets/images/home/masaje-terapeutico-home.png)",
    height: "90vh",
    width: "100%",
      ...
      <Grid item xs={12} sm={12} md={12} lg={12} xl={12}>
        <div className="container mx-auto xl:px-36 lg:px-36 px-0 ">
          <div className="w-1/2">
            ...
            >
              Masaje
              <span style={{ color: "#3F34BB" }}> Terapéutico</span>
            </Typography>
            <Typography
              variant="h6"
            ...
            >
              Masaje de
              <span className="font-bold"> alta intensidad</span>, que trata
              afecciones musculares cómo
              <span className="font-bold">
                espasmos, tensión profunda ó sensación de rigidez.
              </span>
            </Typography>
            <div className="mt-10">
              <CustomLinkButton
