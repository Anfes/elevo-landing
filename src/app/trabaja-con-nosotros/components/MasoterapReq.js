...
const masoterapReqList = [
  {
    title: "Tener un título profesional de masoterapia",
    description:
    ...
    icon: <PhoneIphoneIcon className="text-[#3F34BB] text-6xl mr-4" />,
  },
  {
    title: "Tener un título profesional de masoterapia",
    description:
  ...
  return (
    <div className="container sm:mx-auto xl:px-36 lg:px-36 px-8 min-w-full py-32">
      <Typography className="text-4xl text-[#2D3145] font-bold mb-4">
        Requisitos para <span className="text-[#3F34BB]"> masoterapeutas</span>
      </Typography>
      ...
      <div className="grid md:grid-cols-2 grid-cols-1 gap-12">
        {masoterapReqList.map((item, index) => (
